...
<body>
	...
	<div style="width: 100%; float: left;">
		<div
			style="display: inline-block; float: left; width: 45%; height: 100%;">
			<s:include value="carousel.html" />
		</div>
		<div
			style="display: inline-block; float: left; width: 35%; height: 100%">
		...
		<div
			style="display: inline-block; float: left; width: 20%; height: 100%">
			<table border="1" width="100%" bordercolor="#43A3E9">
				<tr>
					<td>
						<h2>
	...
	<div style="width: 100%; float: left;">
		<div style="display: inline-block; float: left; width: 33.3%">
			<table border="1" width="100%" bordercolor="#43A3E9">
				<tr>
					<td>
						<h2>
