...
import com.cjlu.newspublish.daos.impl.WeatherDaoImpl;
import com.cjlu.newspublish.models.Weather;
import com.cjlu.newspublish.services.WeatherService;
import com.cjlu.newspublish.utils.DateUtils;
import com.cjlu.newspublish.utils.DomReadXmlUtils;

@Service("weatherService")
public class WeatherServiceImpl extends BaseServiceImpl<Weather> implements
		WeatherService {
	...
	@Override
	public Weather getWeather(Weather model, HttpServletResponse httpResponse)
			throws IOException, ParseException {

		List<String> strings = null;
		String area = model.getCounty();
		if (area.length() > 2) {
			if (area.endsWith("ÊÐ") || area.endsWith("ÏØ")) {
